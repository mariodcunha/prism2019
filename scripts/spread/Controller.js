...
// 		var completeCount = 0;
// 		var tileColor = options.randomColor ? color() : options.color;
// 		// var e=document.getElementById('myInlay');
// 		// var cs;
// 		// var tileColor ;
// 		// if(e) {
// 		// 	cs=document.defaultView.getComputedStyle(e,null);
// 		// 	tileColor=cs.getPropertyValue('backgroundImage');
// 		// 	console.log(tileColor) ;
// 		// }



// 		// var elementExists = document.getElementsByClassName("inlay");
// 		// 		var tileColor ;
// 		// 		if(elementExists) {
// 		// 			tileColor = document.getElementsByClassName("inlay").style.backgroundColor() ;
// 		// 		}
